    ...
    return (
        <View className="flex-1 flex justify-end">
            ...
            <View className="p-5 pb-10 space-y-8">
                ...
                {/* Login Button */}
                <TouchableOpacity
                    onPress={() => navigation.navigate("Login")} // Replace "Login" with the screen name for your login screen
                    style={{ backgroundColor: theme.bg(1) }}
                    className="mx-auto p-3 px-12 rounded-full"
                >
                    <Text
                ...
                {/* Sign Up Button */}
                <TouchableOpacity
                    onPress={() => navigation.navigate("SignUp")} // Replace "SignUp" with the screen name for your sign-up screen
                    style={{ backgroundColor: theme.bg(1) }}
                    className="mx-auto p-3 px-12 rounded-full"
                >
                    <Text
